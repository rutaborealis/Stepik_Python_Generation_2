...
for user in users:
    if user['phone'][-1] == '8':
        users_filtered.append(user['name'])

print(*sorted(users_filtered))
...
print(f"{request}: {courses[request]}")
...
for char in input_text:
    if char in letters_morse:
        print(letters_morse[char], end=' ')
